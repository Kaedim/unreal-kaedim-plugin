...
#include "KaedimPluginEditorMode.generated.h"
 ...
 */
UCLASS()
class UKaedimPluginEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_KaedimPluginEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UKaedimPluginEditorMode();
	virtual ~UKaedimPluginEditorMode();
