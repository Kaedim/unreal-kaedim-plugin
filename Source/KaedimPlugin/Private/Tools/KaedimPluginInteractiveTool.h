...
#include "KaedimPluginInteractiveTool.generated.h"


/**
 * Builder for UKaedimPluginInteractiveTool
 */
UCLASS()
class KAEDIMPLUGIN_API UKaedimPluginInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UKaedimPluginInteractiveTool
 */
UCLASS(Transient)
class KAEDIMPLUGIN_API UKaedimPluginInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UKaedimPluginInteractiveToolProperties();
...
/**
 * UKaedimPluginInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class KAEDIMPLUGIN_API UKaedimPluginInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UKaedimPluginInteractiveToolProperties> Properties;
