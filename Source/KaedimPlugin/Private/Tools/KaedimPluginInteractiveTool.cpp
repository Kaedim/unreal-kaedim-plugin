...
#include "KaedimPluginInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UKaedimPluginInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UKaedimPluginInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UKaedimPluginInteractiveTool* NewTool = NewObject<UKaedimPluginInteractiveTool>(SceneState.ToolManager);
...
UKaedimPluginInteractiveToolProperties::UKaedimPluginInteractiveToolProperties()
{
...
void UKaedimPluginInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UKaedimPluginInteractiveTool::Setup()
{
	...
	Properties = NewObject<UKaedimPluginInteractiveToolProperties>(this, "Measurement");
...
void UKaedimPluginInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UKaedimPluginInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UKaedimPluginInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UKaedimPluginInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UKaedimPluginInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UKaedimPluginInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UKaedimPluginInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UKaedimPluginInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UKaedimPluginInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
